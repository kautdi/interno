...
const Create: FC = () => {
  return (
    <section className="homeCreate">
        <div className="text-block homeCreate__text-block">
            <h1 className="content__head homeCreate__content-head content__head__headOne">We Create The Art
                Of Stylish Living
                Stylishly</h1>
            <p className="content__desc homeCreate__content-desc content__desc__large">We Create The Art
                It is a long established fact that a reader will be distracted by the of readable content of a page 
                when lookings at its layouts the points of using 
                that it has a more-or-less normal.</p>
            <div className="icon-text homeCreate__callUs">
                <i><svg width="71" height="71" viewBox="0 0 71 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="text-block">
                    <h1 className="content__head content__head__bold">012345678</h1>
                    <p className="content__desc homeCreate__content-desc content__desc__large">Call Us Anytime</p>
                </div>
            </div>
            <Link to="/contact" className="button homeCreate__button button__default">
                Get Free Estimate
        ...
        <div className="pic-block homeCreate__pic-block">
        </div>
    </section>
  );
};
