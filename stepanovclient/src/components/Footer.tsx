...
const Footer: FC = () => {
  return (
    ...
    <div className="brand-block footer__brand-block">
        <div className="logo-block footer__logo-block">
            <a href="" className="logo-link">
              <img src={Logo} alt=""/>
            </a>
        </div>
        <p className="content__desc brand-block__content-desc  content__desc__large">
            It is a long established fact that a reader will be distracted lookings.
        </p>
        <div className="media-links footer__media-links">
            <a href="" className="media-link footer__media-links__media-link">
                <i><svg width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.18359 10.875L9.67578 7.64062H6.54688V5.53125C6.54688 4.61719 6.96875 3.77344 8.375 3.77344H9.81641V0.996094C9.81641 0.996094 8.51562 0.75 7.28516 0.75C4.71875 0.75 3.03125 2.33203 3.03125 5.14453V7.64062H0.148438V10.875H3.03125V18.75H6.54688V10.875H9.18359Z" fill="#292F36"/></svg></i>
            </a>
            <a href="" className="media-link footer__media-links__media-link">
    ...
    <ul className="site-items footer__site-items">
        ...
        <li className="site-item footer__site-item">
            <Link to="/ourteams" className="content__desc site-item__content-desc content__desc__largeDesc">
                Our Team
            </Link>
        </li>
        <li className="site-item footer__site-item">
            <Link to="/contact" className="content__desc site-item__content-desc content__desc__largeDesc">
                Contact Us
            </Link>
        </li>
        <li className="site-item footer__site-item">
            <Link to="/service" className="content__desc site-item__content-desc content__desc__largeDesc">
                Services
            </Link>
        </li>
    </ul>
    ...
    <ul className="site-items footer__site-items">
        <li className="site-item footer__site-item">
            <h1 className="content__head site-item__content-head content__head__headThree">Contact</h1>
        </li>
        <li className="site-item footer__site-item">
