...
const AboutNews:FC<IAboutNews> = ({head, date, desc,imgLink, headTwo, descTwo, category,citata,Tag }) => {
  return (
    <section className="aboutNews">
    <h1 className="content__head aboutNews__content-head content__head__headOne">
        {head}
    </h1>
    <div className="pic-block">
        <img src="../img/singleNews.png" alt="" />
    </div>
    <div className="dateCat">
        <p className="content__desc dateCat__content-desc content__desc__small">{date}</p>
        <p className="content__desc dateCat__content-desc content__desc__small">{category}</p>
    </div>
    <p className="content__desc aboutNews__content-desc content__desc__large">{desc}</p>
    <div className="citat aboutNews__citat">
        <div className="text-block aboutNews__citat__text-block">
            <h2 className="content__head aboutNews__citat__content-head content__head__headOne">
                “
            </h2>
            <h2 className="content__head aboutNews__citat__content-head content__head__headThree">
                {citata}
            </h2>
        </div>
    ...
    <p className="content__desc aboutNews__content-desc content__desc__large">{desc}</p>
    <div className="pic-block">
        <img style={{marginTop:"30px"}} src="../img/singleNews2.png" alt="" />
    </div>
    <p className="content__desc aboutNews__content-desc content__desc__large">{descTwo}</p>
    <div className="tags-media">
        <div className="tags tags-media__tags">
            <h1 className="content__head tags__content-head content__head__headFive">
                Tags
            </h1>
            {Tag && Tag.map((tag, index) => (
                <div key={index} className={`tag-cat tags__tag-cat ${index === 0? 'tag-cat__active' : ''}`}>
                <p className="content__desc aboutNews__content-desc content__desc__small">{tag}</p>
                </div>
            ))}
        </div>
        <div className="medialinks tags-media__medialinks aboutNews__medialinks">
